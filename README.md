...
### 2.3 Export data hasil paket capture
 ...
 1. Setelah memiliki packet, pilih pada menu bar File -> Export Objects -> (protokol yang diinginkan). Pada contoh ini dipilih protokol
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzIzNjc1NywtODE1MTk5MzY4LDExNT
